...
#' Construct differential feature set
#'
#' \code{diff_fea} returns the differential feature set of given samples by merging valid fature sets of given samples and the remaining samples in the database.
#'
#' @param y1: Sample labels of the first class.
#' @param y2: Sample labels of the second class.
#' @param df: The indication matrix of HC pairwise test.
#'
#' @return: The output will be a vector of differential feature set.

diff_fea=function(y1,y2,df){
  y_ind=c(y1,y2)
  vs=NULL 
  ...
  vs=vs[vs!=4000]  ## differential feature set
  return(vs)
}
